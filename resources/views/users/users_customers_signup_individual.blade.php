    ...
    <body>
                    ...
                    <div class="row px-3">
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="form-group position-relative w-pass">
                                ...
                                <span class="error_msg" id="error_confirm_password">
                            </div>
                        </div>
                        <!-- LOCATION -->
                        <div class="col-12 mb-5">
                            <div class="form-group position-relative">
                                <span class="input-icon"><img src="{{ url('/public/users/assets/images/icons/location.png') }}" alt="icon" class="img-fluid"></span>
                        ...
                        <div class="col-md-4 col-sm-12 mb-5">
                            <div class="form-group position-relative">
                                <span class="input-icon"><img src="{{ url('/public/users/assets/images/icons/id-number.png') }}" alt="icon" class="img-fluid"></span>
                        ...
                        <div class="col-md-4 col-sm-12 mb-5">
                            <div class="form-group position-relative">
                                ...
                                <input type="text" class="form-control mb-3" placeholder="Enter Expiry date of ID" aria-label="expiry_date" name="expiry_date" id="expiry_date">
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#frm_signup").validate({
                    ...
                    errorPlacement: function (error, element) {
                        ...
                        } else if (element.attr("name") == "sur_name") {
            ...
            /*$("#telephone").intlTelInput({
                ...
                utilsScript: "{{ url('/public/users/assets/plugin/select-flag/js/utils.js') }}"
            });*/
            // -------------- PHONE NO. COUNTRIES CODE ------------- //     
        </script>
        <!-- SCRIPTS -->
